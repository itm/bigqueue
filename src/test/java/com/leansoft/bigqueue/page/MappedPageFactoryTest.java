...
public class MappedPageFactoryTest {
    ...
    public void testSingleThread() throws IOException {
        ...
        for (int i = 0; i <= 100; i++) {
            ...
            assertTrue("iPageLastModifiedTime was " + iPageFileLastModifiedTime + " and should be >= " + start, iPageFileLastModifiedTime >= start);
            assertTrue("iPageLastModifiedTime was " + iPageFileLastModifiedTime + " and should be <= " + currentTime, iPageFileLastModifiedTime <= currentTime);
        ...
        assertEquals(Long.MAX_VALUE, index);
